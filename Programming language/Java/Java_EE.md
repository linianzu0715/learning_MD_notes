...
##### 1,1,2  什么是Spring Beans？

Spring Beans是构成Spring应用核心的Java对象。这些对象由Spring IOC容器实例化、组装、管理。这些对象通过容器中配置的元数据创建，例如，使用XML文件中定义的创建。



##### 1,1,3  说一下Spring中支持的bean作用域
...
##### 1,1,4  BeanFactory和ApplicationContext有什么区别？
...
##### 1,1,6  解释Spring框架中bean的生命周期

ApplicationContext容器中，Bean的生命周期流程如上图所示，流程大致如下：

![preview](https://pic1.zhimg.com/v2-e87d88dc80c2ee64c699d017084b6e4c_r.jpg)
...
##### 1,2,4  你推荐哪种依赖注入？构造器依赖注入还是Setter方法依赖注入？
